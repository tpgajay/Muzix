...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!plan) return message.reply({ content: `\<a:crosss:1210629485309730907>\ | You didn't provide any type of plans: \`${plans.join(", ")}\`` });

        if (!plans.includes(plan))
            return message.reply({ content: `\<a:crosss:1210629485309730907>\ | You didn't provide any valid type of plans: \`${plans.join(", ")}\`` });
